    ...
    <div className="w-full min-h-screen bg-zinc-200 p-3 sm:p-5 flex items-center justify-center font-sans tracking-tight antialiased text-neutral-900">
      <div className="relative w-full max-w-md bg-zinc-50 rounded-[32px] sm:rounded-[40px] shadow-2xl overflow-hidden border border-neutral-300 p-6 sm:p-8">
        <div className="text-center mb-6">
          ...
          <h1 className="text-xl sm:text-2xl font-black text-neutral-900">Create Account</h1>
          <p className="text-xs text-neutral-400 font-mono mt-1">Join the LoudLayer community</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-3">
          <div>
            <label className="text-[11px] font-medium text-neutral-500 mb-1.5 block">Name</label>
            <input
              value={name}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full h-11 bg-neutral-900 text-white text-sm font-bold rounded-xl hover:bg-orange-500 disabled:opacity-50 transition cursor-pointer flex items-center justify-center gap-2"
          >
